...
function IconBeaker({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 0 1 4.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15M14.25 3.104c.251.023.501.05.75.082M19.8 15a2.25 2.25 0 0 1 .244 1.52l-.93 4.27A2.25 2.25 0 0 1 16.913 22.5H7.087a2.25 2.25 0 0 1-2.2-1.61l-.93-4.27A2.25 2.25 0 0 1 4.2 15h15.6Z" />
    </svg>
  );
}
...
function IconArrowsUpDown({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor">
...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/migration/seo-recovery", label: "SEO Recovery", icon: IconChartBar },
      { href: "/admin/migration/content-clusters", label: "Content Clusters", icon: IconGrid },
      { href: "/admin/migration/cluster-plan", label: "Cluster Plan", icon: IconDocument },
      { href: "/admin/migration/redirect-plan", label: "Redirect Plan", icon: IconArrowsUpDown },
    ],
  },
];
